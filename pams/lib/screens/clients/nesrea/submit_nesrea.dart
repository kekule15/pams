...
import 'package:pams/screens/clients/nesrea/nesrea_implementation.dart';
...
import 'submit_nesrea_data_model.dart';

class SubmitNESREAPage extends StatefulWidget {
  final SubmitNESREAData? model;
  final int? locationId;

  const SubmitNESREAPage({Key? key, this.model, this.locationId})
      : super(key: key);
