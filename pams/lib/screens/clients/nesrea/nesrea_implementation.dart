...
class NESREAImplementation {
  // get client location
  Future<Map<String, dynamic>?> getNESREATemplates(int? locationId) async {
    ...
    var url = Constants.base_url +
        "/FieldScientistAnalysisNesrea/get-nesrea-template?LocationId=$locationId";
