...
//
//     final getAllDprSubmittedTest = getAllDprSubmittedTestFromJson(jsonString);

import 'dart:convert';

GetAllDprSubmittedTest getAllDprSubmittedTestFromJson(String str) => GetAllDprSubmittedTest.fromJson(json.decode(str));

String getAllDprSubmittedTestToJson(GetAllDprSubmittedTest data) => json.encode(data.toJson());

class GetAllDprSubmittedTest {
    GetAllDprSubmittedTest({
        this.status,
        this.message,
        this.returnObject,
    });
    ...
    factory GetAllDprSubmittedTest.fromJson(Map<String, dynamic> json) => GetAllDprSubmittedTest(
        status: json["status"],
