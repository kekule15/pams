...
class SelectSampleType extends StatefulWidget {
  ...
  const SelectSampleType(
      {Key? key, this.clientId, this.clientName})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder(
            future: SampleImplementation().getClientsTemplates(widget.clientId),
            builder: (context, AsyncSnapshot snapshot) {
              ...
              return snapshot.connectionState == ConnectionState.waiting
                  ...
                  : snapshot.hasData
                                    ...
                                    Navigator.of(context)
                                        .push(MaterialPageRoute(
                                            builder: (context) => ClientsSample(
                                                  ...
                                                  templateData: data!['returnObject']['fmEnvs'],
                                                )));
                                  },
                                  child: myListWidget(
                                    ...
                                    Navigator.of(context)
                                        .push(MaterialPageRoute(
                                            builder: (context) => ClientsSample(
                                                  ...
                                                  sampleType: 'dpRs',
                                                  clientName: widget.clientName,
                                                  templateData: data['returnObject']['dpRs'],
                                                )));
                                  },
                                  child: myListWidget(
                                      data['returnObject']['dpRs'], 'dpRs')),
                            ),
                            SizedBox(
                              height: 20,
                            ),
                                    ...
                                    Navigator.of(context)
                                        .push(MaterialPageRoute(
                                            builder: (context) => ClientsSample(
                                                  ...
                                                  sampleType: 'nesreAs',
                                                  clientName: widget.clientName,
                                                  templateData: data['returnObject']['nesreAs'],
                                                )));
                                  },
                                  child: myListWidget(
                      ...
                      : Center(child: Text('No template yet for this client'));
            }),
      ),
    );
  }
